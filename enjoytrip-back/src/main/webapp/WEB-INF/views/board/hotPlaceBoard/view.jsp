  ...
  <div class="col-lg-8 col-md-10 col-sm-12">
    ...
    <div class="row">
      ...
      <c:forEach var="img" items="${imgList}">
        <img src="http://localhost/enjoytrip/upload/${img}" class="img-fluid">
      </c:forEach>
      ...
      <c:if test="${!empty article.fileInfos}">
        <div class="mt-3">
          ...
          <ul>
            ...
            <li>${file.originalFile} <a href="${root}/hotPlaceFile/download/${file.saveFolder}/${file.originalFile}/${file.saveFile}">[다운로드]</a>
              </c:forEach>
          </ul>
        </div>
      </c:if>
      ...
      <div class="d-flex justify-content-end">
        ...
        <c:if test="${login.userId eq article.userId}">
          ...
          <script>
            document.querySelector("#btn-mv-modify").addEventListener("click", function () {
              ...
              form.setAttribute("action", "${root}/hotPlaceBoard/modify");
              form.submit();
            });
            ...
            document.querySelector("#btn-delete").addEventListener("click", function () {
              if(confirm("정말 삭제하시겠습니까?")) {
                let form = document.querySelector("#form-no-param");
                form.setAttribute("action", "${root}/hotPlaceBoard/delete");
                form.submit();
              }
            });
          </script>
