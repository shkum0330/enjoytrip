...
@RestController
@RequestMapping("/tripInfoFile")
public class TIFileDownloadController {

	private static final Logger logger = LoggerFactory.getLogger(TIFileDownloadController.class);
