...
@RestController
@RequestMapping("/myPlanFile")
public class MPFileDownloadController {

	private static final Logger logger = LoggerFactory.getLogger(MPFileDownloadController.class);
